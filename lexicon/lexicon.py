...
LEXICON_RU: dict[str, str] = {
    ...
    '/help': 'Выбери площадку Wildberries или Ozon, c которой хочешь поработать\n'
            ...
            'Отчеты по продажам обновляются 3 раза в день в 5-00, 14-00 и 20-00 по московскому времени\n'
             'Если бот не реагирует на команды - значит он выполняет предыдущую. Нужно подождать',
    'no_echo': 'Я тебя не понимаю, посмотри инструкцию /help',
    '/stock': 'Отправляю тебе текущие стоки в абсолютах и днях покрытия',
    '/expiration': 'Отправляю тебе анализ ОСГ по текущим остаткам',
    '/stock_history': 'Отправляю тебе динамику стока',
